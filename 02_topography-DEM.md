...
1. Creating a dedicated conda environment
2. Installing compilation dependencies (`gcc`, `gdal`, `boost`, `eigen`, etc.)
3. Cloning the official `LSDTopoTools2` GitHub repository
4. Compiling the software from source using `cmake` and `make`
